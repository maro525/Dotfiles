  ...
  (setq-default
   ...
   '(yaml
     ...
     (auto-completion
      ...
      auto-completion-idle-delay 1.3
...
before packages are loaded."
  ...
  (load "~/.emacs.d/elisp/flycheck-cargo.el")
